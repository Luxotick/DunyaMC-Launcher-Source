...
function addAccount(data) {
    ...
    div.id = data.uuid;
    div.innerHTML = `
        <img class="account-image" src="https://minotar.net/bust/${data.name}/100">
...
function headplayer(pseudo) {
    document.querySelector(".player-head").style.backgroundImage = `url(https://minotar.net/bust/${pseudo}/100)`;
}