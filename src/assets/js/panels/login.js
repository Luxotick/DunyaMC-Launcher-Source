...
class Login {
    ...
    loginMojang() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            infoLogin.innerHTML = "Mevcut baðlantý...";


            if (mailInput.value == "") {
                infoLogin.innerHTML = "Kullanýcý adý"
            ...
            if (passwordInput.value == "") {
                infoLogin.innerHTML = "Þifreni Gir"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            Mojang.getAuth(mailInput.value, passwordInput.value).then(account_connect => {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Gecersiz e-posta adresi veya þifre'
            })
        })
    }
    ...
    loginOffline() {
        ...
        mojangBtn.innerHTML = "CRACKED - Sifresiz Giris"
        ...
        loginBtn.addEventListener("click", () => {
            ...
            mailInput.disabled = true;
            passwordInput.disabled = true;
            infoLogin.innerHTML = "Baglaniliyor...";


            if (mailInput.value == "") {
                infoLogin.innerHTML = "Gecersiz isim - Sifre girmene gerek yok"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            Mojang.getAuth(mailInput.value, passwordInput.value).then(async account_connect => {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Gecerisz Eposta veya sifre'
            })
        })
    }
}
